            ...
            <div class="row row-no-padding row-col-separator-lg">
                ...
                <div class="col-md-12 col-lg-6 col-xl-4">
                    <div class="kt-widget24">
                        ...
                        @php
                            $numerator = \DB::table('users')->where('email', '!=', null)->where('chat_role', '<=', 3)->count();
                            $denominator = \DB::table('users')->where('email', null)->where('chat_role', '<=', 3)->count();
                            $percentage = $denominator > 0 ? (100 - ($numerator / $denominator) * 100) : 0;
                        @endphp
                        <div class="progress progress--sm">
                            <div class="progress-bar kt-bg-brand" role="progressbar" style="width: {{ $percentage }}%;"></div>
                        </div>
                ...
                <div class="col-md-12 col-lg-12 col-xl-4">
                    <div class="kt-widget24">
                        ...
                        <div class="progress progress--sm">
                            <div class="progress-bar kt-bg-danger" role="progressbar" style="width: {{ $percentage }}%;"></div>
                        </div>
