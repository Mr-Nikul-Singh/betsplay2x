<div id="__ajax_title" style="display: none">@if(Auth::user()->chat_role < 3) User registration statistics @else adjustment @endif</div>
                        ...
                        <div class="alert alert-dark fade show mt-3" role="alert">
                            ...
                            <div class="alert-text">
                                <p><strong>Tweak</strong><br>
                                    <span>The chances of losing (substituting a win with a loss by the system) depend on the user's account balance.<br></span></p>
                                <p><strong>Base Chance</strong><br>
                                    <span>The standard chance of losing.</span></p>
                                <p><strong>Maximum Chance</strong><br>
                                    <span>The chance of losing cannot exceed this value.</span></p>
                                <p><strong>Maximum Multiplier</strong><br>
                                    <span>Automatic loss if a person reaches the specified multiplier value.</span></p>
                                <p><strong>Speed</strong><br>
                                    <span>The factor by which the algorithm increases the chances of losing.<br> The lower it is, the lower the chance of losing at a specific balance threshold.</span></p>
                                <p>All games using this system support preview mode.</p>
                            </div>
                        </div>
                    </div>
                </div>
                @php($balanceAdjustments = function($gameId) {
                    ...
                    return <<< HTML
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input id="$gameId-maxMul" oninput="$sendFunc" value="$mm" type="text" class="form-control" placeholder="Maximum Multiplier" aria-describedby="basic-addon2">
                            </div>
                        </div>
                    ...
                    <div class="kt-form" id="kt_form">
                        ...
                        <div class="kt-wizard-v2__content" data-ktwizard-type="step-content">
                            ...
                            <div class="kt-form__section kt-form__section--first">
                                <div class="kt-wizard-v2__form">
                                    <div class="form-group">
                                        <label>Probability <strong>lose</strong> с multiplier 1.01 - 1.50</label>
                                    ...
                                    <div class="form-group">
                                        <label>Probability <strong>lose</strong> с multiplier 1.51 - 2.50</label>
                                    ...
                                    <div class="form-group">
                                        <label>Probability <strong>lose</strong> с multiplier 2.51 - 4.00</label>
                                    ...
                                    <div class="form-group">
                                        <label>Probability <strong>lose</strong> с multiplier 4.01 - 10.00</label>
