    ...
    <div id="w_container" class="g_c g_container roulette col-md-9 col-sm-12">
        ...
        <div class="roulette-container">
            <div class="roulette-header">
                <div class="roulette-bet">Bet: <span id="token_bet">0.00 &nbsp;<i class="fad fa-coins"></i></span></div>
                ...
                <div class="r-row-bottom">
                    ...
                    <div class="r-row r-row-big">
                        ...
                        <div class="r-row-bottom-bottom">
                            <div class="chip chip-row chip-fix" id="1-18" data-chip="1-18"><span>1 To 18</span></div>
