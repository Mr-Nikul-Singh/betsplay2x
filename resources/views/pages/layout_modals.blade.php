    ...
    <div class="md-modal md-email-activation md-s-height md-show md-effect-1">
        <div class="md-content">
            ...
            <div class="email-container">
                <div style="text-align: center">Email Confirmation</div>
                <div>An email has been sent to {{Auth::user()->email}} with a link to confirm your account.</div>

				<br>
                <div class="email_links">
                    <a href="javascript:void(0)" onclick="resend_email()" class="ll">Resend</a>
                    <a href="javascript:void(0)" onclick="window.location.href='/logout'" class="ll" style="margin-left: 5px">Log out</a>
                </div>
            </div>
        </div>
    </div>
                         ...
                         <div class="nano">
                            <div class="nano-content">
                                ...
                                <div class="payment-method" data-wallet-type="4" data-provider="82">
                                    ...
                                    <div class="payment-method-name">Megafon</div>
                                </div>
    ...
    -webkit-appearance: none;
                    ...
                    <div class="payment-total">
                        <div class="payment-total__first-row">
                            <div class="payment-field payment-sum">
                                <label for="deposit-sum">Deposit<span class="sm-hidden"> amount</span></label>
                                <div class="validation-wrapper">
                                    <span class="validation-message"></span>
                                    <div class="wallet-input-wrapper">
                                        <input inputmode="numeric" type="tel" name="amount" id="payment" value="{{$settings->min_in}}" class="numeric-input-validate game-sidebar__input game-sidebar__input_dark" required placeholder="Deposit amount">
			...
			<div class="wallet-area__row">
                    <div class="payment-total">
                        <div class="payment-total__first-row">
                            <div class="payment-field payment-sum">
                                    <label class="payment-field-label" for="deposit-sum">Withdrawal<span class="sm-hidden"> amount</span> 
                                    </label>
                                <div class="validation-wrapper">
                                    <span class="validation-message"></span>
                                    <div class="wallet-input-wrapper">
                                        <input inputmode="numeric" value="{{$settings->min_with}}" type="text" name="amount" id="withv" data-what="Сумма" placeholder="Withdrawal amount" data-min="{{$settings->min_with}}" data-max="15000" data-value-on-nonnumeric="1000" class="numeric-input-validate game-sidebar__input game-sidebar__input_dark" autocomplete="off">
                                        <div class="wallet-input-currency">Руб.</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="payment-total__second-row">
                            ...
                            <div class="payment-help-title"><i class="fad fa-clock"></i>Fast withdrawals</div>
                            <div class="payment-help-desc">
                            Withdrawals from 1 minute to 3 days<br>
                            </div>
                        </div>
                    </div>
            </div>
        ...
        <div class="md-content">
            ...
            <div class="wheel_block row" id="ref_block">
                <div class="wb_c">
                    ...
                    <div class="col-xs-12 col-sm-6">
                            <div class="spin_button" onclick="spin_ref()">Spin</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="md-content">
                ...
                <div class="nano">
                    <div class="nano-content">
                        ...
                        <br>
                        <ul>
                            <li><p style="text-align: center">Every 3 hours, five random people are selected by the system and rewarded with a bonus, while a message about this is sent to the chat.</p></li>
                            <li><p style="text-align: center">To be eligible for the rain, you need to top up your account with 30 coins or more in the last 24 hours.</p></li>
                        </ul>
                    </div>
                </div>
            </div>
