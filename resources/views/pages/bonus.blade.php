    ...
    <div class="bonus_page_container">
        ...
        <div class="bonus_option" onclick="$('#ref').toggleClass('md-show', true)">
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_button">Learn more</div>
            </div>
        </div>
        ...
        @if(strpos(Auth::user()->login, 'id') !== false)
            <div class="bonus_option" onclick="window.open('https://vk.com/bets.play2x')">
                ...
                <div class="bonus_option_content">
                    ...
                    <div class="bonus_option_name">VK Group</div>
                    <div class="bonus_option_description">Join the VK group and receive 0.45 &nbsp;<i class="fad fa-coins"></i> to your balance!</div>
                    <div class="bonus_option_button">Go to</div>
                </div>
            </div>
        @endif
        <div id="notificationOption" style="display: none" class="bonus_option">
            ...
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_description">Subscribe to notifications with promo codes and news and receive 1 &nbsp;<i class="fad fa-coins"></i> to your balance!</div>
    ...
    <div class="bonus_page_container">
        <div class="bonus_option" onclick="window.open('https://vk.com/bets.play2x')">
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_name" style="width: 75%;">Partnership</div>
                <div class="bonus_option_description" style="margin-bottom: 64px;">Are you the administrator of a VK group? We can offer daily unique promo codes for your group.</div>
                <div class="bonus_option_button">Contact us</div>
            </div>
        </div>
        <div class="bonus_option" onclick="$('#rain').toggleClass('md-show', true)">
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_description">
                    Every few hours<br>an event occurs in the chat,<br>giving a bonus<br>to random people.
                </div>
                <div class="bonus_option_button">Learn more</div>
            </div>
        </div>
        <div class="bonus_option" onclick="$('.md-promo').toggleClass('md-show', true)">
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_description">Enter a promo code or referral code and receive a bonus to your balance!</div>
