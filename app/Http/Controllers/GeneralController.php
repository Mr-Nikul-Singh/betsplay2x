...
class GeneralController extends Controller {
    ...
    public static function logTransaction($sum, $type, $data, $id = null) {
        ...
        if($type == 2) {
            Achievement::award(new Game1Achievement(), $id);
            Achievement::awardProgress(new Game1000Achievement(), 1);
            Achievement::awardProgress(new Game5000Achievement(), 1);
        }
	...
	public static function logTransactionFake($sum, $type, $data, $id) {
        ...
        if($type == 2) {
            Achievement::award(new Game1Achievement(), $id);
            Achievement::awardProgress(new Game1000Achievement(), 1, $id);
            Achievement::awardProgress(new Game5000Achievement(), 1, $id);
        }
...
if($user->client_seed == null) {
	...
	public function fakegamestairs($salt) {
        ...
        if (is_null($user)) return 'error -1';
						Achievement::awardProgressFake(new Game1Achievement(), 1, $uid);
						Achievement::awardProgressFake(new Stairs100Achievement(), 1, $uid);
        }
        ...
        if(!$this->isDemo()) {
            ...
            if (is_null($user)) return 'error -1';
			Achievement::awardProgressFake(new Game1Achievement(), 1, $uid);
            Achievement::awardProgressFake(new Tower100Achievement(), 1, $uid);
        }
...
public function fakegamewheel($salt) {
        ...
        if(!$this->isDemo()) {
            if ($win) {
				Achievement::awardProgressFake(new Game1Achievement(), 1, $uid);
                Achievement::awardProgressFake(new Wheel50Achievement(), 1, $uid);
                Achievement::awardProgressFake(new Wheel300Achievement(), 1, $uid);
                Achievement::awardProgressFake(new Wheel1000Achievement(), 1, $uid);
            }
						if($user->level < 3) {
                $user->level = 3;
            }
	...
	public function fakegamecoinflip($salt) {
        ...
        if(!$this->isDemo($id) && $profit > 0) {
			Achievement::awardProgressFake(new Game1Achievement(), 1, $uid);
            Achievement::awardProgressFake(new Coinflip25Achievement(), 1, $uid);
            Achievement::awardProgressFake(new Coinflip150Achievement(), 1, $uid);
            Achievement::awardProgressFake(new Coinflip500Achievement(), 1, $uid);
        }
...
$mulrandfinally=$mulrand/1000;
      ...
      //  return json_encode(array('id' => $id));
        ...
        if(!$this->isDemo($id)) {
			Achievement::awardProgressFake(new Game1Achievement(), 1, $uid);
            Achievement::awardProgressFake(new Crash50Achievement(), 1, $uid);
            Achievement::awardProgressFake(new Crash150Achievement(), 1, $uid);
            Achievement::awardProgressFake(new Crash500Achievement(), 1, $uid);
        }
	...
	public function fakegamedice($salt) {
        ...
        if(!$this->isDemo()) {
            if ($win) {
				Achievement::awardProgressFake(new Game1Achievement(), 1, $uid);
				Achievement::awardProgressFake(new Game1000Achievement(), 1, $uid);
                Achievement::awardProgressFake(new Dice50Achievement(), 1, $uid);
                Achievement::awardProgressFake(new Dice200Achievement(), 1, $uid);
                Achievement::awardProgressFake(new Dice1000Achievement(), 1, $uid);
            }
			if($user->level < 3) {
                $user->level = 3;
            }
